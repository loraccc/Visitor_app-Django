...
SECRET_KEY = 'django-insecure-r$2!oqfvboiom^8(zhl_sbvnqq+u3yrx!vh5zr2wisss-fz8s*'
...
ROOT_URLCONF = 'Visitor_Proj.urls'
...
WSGI_APPLICATION = 'Visitor_Proj.wsgi.application'
